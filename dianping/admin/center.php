...
$linkdb=array("核心设置"=>"$admin_path&job=config","付费推广设置"=>"$admin_path&job=guide","发布信息权限设置"=>"$admin_path&job=post","置顶信息设置"=>"$admin_path&job=top","联系人信息设置"=>"$admin_path&job=contact");
