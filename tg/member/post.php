...
if($action=="postnew")
{
	...
	refreshto("list.php?job=list","<a href='list.php?job=list'>返回列表</a> <a target='_blank' href='../bencandy.php?fid=$fid&id=$id'>查看效果</a>",600);
...
elseif($action=="del")
{
	...
	refreshto("list.php?job=list","删除成功");
}
