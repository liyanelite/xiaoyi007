...
if($atc=="do"){
	...
	if($step==2){
		...
		echo "<A HREF=\"$Murl/member/post.php?job=edit&fid=$fid&id=$id\">修改</A><br><A HREF=\"$city_url/post.php?action=del&fid=$fid&id=$id\" onclick=\"return confirm('你确认要删除吗?');\">删除</A><br>";
